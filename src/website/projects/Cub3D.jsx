    ...
    return (
        <>
            ...
            <div className="head-titele">
                    <h1 className="head-information-project">Cub3D <img style={{width: '140px', marginTop: '10px'}}  className="image-project-info" src="/images/irc-logo.png" ></img>
                    </h1>
                    ...
                    <div style={{display:'flex'}}>
                        ...
                        <div className="edit-paragraph lineRight">
                        <p >
                        <h2 style={{marginTop: '0px'}}> Cub3D 42 Implementation</h2>
                            The Cub3D 42 project involves implementing an IRC server in C++.
                        ...
                        <div style={{display:'flex', justifyContent: 'center',  marginBottom: '30px'}}>
                            ...
                            <h2 style={{marginTop: '0px'}}>Checkout more resources </h2>
                                <ul>
                                    ...
                                    <li> <a style={{color: 'white'}} target="_blank" href="https://medium.com/@afatir.ahmedfatir/small-irc-server-ft-irc-42-network-7cee848de6f9#:~:text=Part%203%3A%20Use%20the%20poll()%20function%20to%20check%20if%20an%20event%20has%20occurred.">Small IRC Server [Cub3D 42 network]</a></li>
